...
$sql2 = mysqli_query($con, "SELECT * FROM employeedetails WHERE merchant_id='$userid' and empid='$empid';");
$empname = '';
$des = '';
...
<div class="container">
    ...
    <table class="header" style="width:100%;">
        <tbody>
            <tr>
                <th rowspan="3" align="left"><img src="../merchant'.$image.'" height="50px" width="60px"></th>
            </tr>
            <tr>
