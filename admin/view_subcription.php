                    ...
                    <div class="pcoded-content">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">View Subcription</h5>
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                ...
                                $query = mysqli_query($con, "select payment_subscription.*,merchant.headname from  payment_subscription, merchant where payment_subscription.id=merchant.id");
                                ...
                                ?>
                                    <tr style="border-bottom: 1px solid black;">
                                       <td style="text-align: center;background-color:white"><?php echo $i; ?></td>
                                        ...
                                        <td style="text-align: center;background-color:white"><?php echo $plan; ?></td>
