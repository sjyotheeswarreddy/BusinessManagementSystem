                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <form class="font-weight-bold" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group row" id="two">
                                                                <label class="col-sm-3 col-form-label  text-primary font-weight-bold" id="profile">Head Name:</label><?php echo $Head_Name; ?>
                                                            </div>
                                                           <div class="form-group row"id="two">
                                                            ...
                                                            <div class="form-group row"id="two">
                                                                <label class="col-sm-3 col-form-label text-primary font-weight-bold"id="profile3">Business Name :</label><?php echo $Name; ?>
                                                                <div class="col-sm-10">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row"id="two">
                                                           ...
                                                           <center><button type="submit" name="submit" class="btn btn-primary waves-effect waves-light"><a href="update.php?updateid=<?php echo $Sno; ?>">Edit</a></button></center>                                                           <!-- <div class="form-group row">
