...
-->
    ...
    <label for="employeeid" class="col-sm-2 col-form-label">Select EmpID :</label>
    ...
    <?php }?>
      ...
      <input type="hidden" id="myempid" name="myempid"></input>
</div>
...
?>
    ...
    <script type="text/javascript">
        ...
        $('#myempid').val();
        myval=$('#myempid').val($("#employeeselect option:selected").text());
