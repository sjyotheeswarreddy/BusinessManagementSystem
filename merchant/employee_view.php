                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Employees View</h5>
                                    ...
                                    <div class="page-body">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-block table-border-style">
                                                ...
                                                <table class="table lms_table_active table-bordered" style="width:890px;">
<thead class="text-center">
<tr>
<th scope="col" colspan="1"  class="text-white bg-primary p-2 rounded-left">S.No</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2">Employee ID</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2">Date of joining</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2">Employee Name</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2">Role</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2">Address</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2">Employee Image</th>
<th scope="col" colspan="1"  class="text-white bg-primary p-2 rounded-right">Manage</th>
</tr>
</thead>
...
$sql = mysqli_query($con, "SELECT * FROM employeedetails WHERE merchant_id = '$userid'");
while ($data = mysqli_fetch_array($sql)) {
    $id=$data['id'];
    $empid = $data['empid'];
    $dateof = $data['dateof'];
...
<td ><?php echo $dateof; ?></td> 
<td ><?php echo $empname; ?></td>
<td ><?php echo $emprole; ?></td>
<td ><?php echo $empadd; ?></td>
<td ><img src="../employee/<?php echo $empimage; ?>" style="width: 50px;height: 50px; border-radius: 50%;"></td>
<td ><a href="employee_update.php?id=<?php echo $id; ?>" ><i class="fas fa-edit fa-1x" id="update"></i></a>
     <a href="delete_employee.php?id=<?php echo $id; ?>" ><i class="fas fa-trash fa-1x" id="delete"></i></a>
     
                      <?php 
                    if($data['status']=="a") 
  
                         echo 
"<a href=employee_deact.php?id=".$data['id']."><i class='fas fa-solid green fa-1x fa-eye' style='color:green;'></i></a>";
                    else 
                        echo 
"<a href=employee_act.php?id=".$data['id']."><i class='fas fa-solid red fa-1x fa-eye-slash' style='color:red;'></i></a>";
                    ?>
