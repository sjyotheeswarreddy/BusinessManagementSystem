                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Invoices View</h5>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                        include('config.php');
                                                        $query = mysqli_query($con,"SELECT * FROM invoice WHERE user_id='$userid'");
                                                        $i = 1;
                                                        while ($row = mysqli_fetch_array($query)) { ?>
                                                            ...
                                                            <td>
                                                                <a href="invoice_pdf.php?id=<?php echo $row['id'];?>&mode=view"><button type="button" class="btn btn-info pt-0 ps-0 pb-1 pe-1">View</button></a><br>
                                                               
                                                            </td>
                                                            <td> <a href="invoice_pdf.php?id=<?php echo $row['id'];?>&mode=download"><button type="button" class="btn btn-info pt-0 ps-0 pb-1 pe-1">Download</button></a></td>
                                                            </tr>
                                                            <?php $i++; } ?>
                                                        </tbody>
                                                    </table>
