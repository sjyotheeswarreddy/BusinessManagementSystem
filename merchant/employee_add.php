...
if (isset($_POST['submit'])) {
 ...
 $datejoin = mysqli_real_escape_string($con,$_POST['dajoin']);
 $status = 'a';
 $businessname = 'as';
 $files = $_FILES['employeeimage'];
 $filename = $files['name'];
 $filetmp = $files['tmp_name']; 
 $folder1= '../employee/employee/'.$filename;
 $folder = 'employee/'.$filename;
 move_uploaded_file($filetmp, $folder1);

 $mysql = mysqli_query($con, "SELECT * FROM employeedetails WHERE merchant_id='$userid'");
 $mydata = mysqli_fetch_array($mysql);
 $empcount = 0;
 if($mydata!=null){
    $empcount = mysqli_num_rows($mysql);
 }
 $empcount = ($empcount + 1);
 $empid = substr($businessname, 0, 3).$userid.$empcount;
 
 $sql = "INSERT INTO employeedetails (merchant_id, empid,dateof,empname, emprole, empqua, empadd, empgen, empimg, businessname, status) VALUES (".$userid.", '".$empid."','".$datejoin."', '".$employeename."', '".$employeerole."', '".$employeequa."', '".$employeeadd."', '".$employeegen."', '".$folder."', '".$businessname."', '".$status."')";
 ...
 if ($sql) {
        ...
        echo '<script type="text/javascript">';
        echo 'alert("Failed to add Employee...");';
        echo 'window.location.href="employee_add.php";';
        echo '</script>';
    }
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Employees Add</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="bg-primary text-white card-header">
                                                        <h5 class="text-white">Add Employees</h5>
                                                          </div>
                                                    <div class="card-block">
                                                        ...
                                                        <form class="font-weight-bold" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Date of joining  :</label>
                                                                <div class="col-sm-10">
                                                                	<input type='date' id='dajoin' class="form-control" name='dajoin' placeholder="Date of joining" />
                                                                    <!-- <input type="text" name="dajoin" class="form-control" placeholder="Date of joining"> -->
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="employeerole" class="form-control"  placeholder="employee role">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Qualification  :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="employeequa" class="form-control"   placeholder="Qualification">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Address :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="employeeadd"class="form-control" placeholder="adress" >
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="employeegen"class="form-control"    placeholder="adress" >
                                                                </div>
                                                            </div>
                                                           
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Profile Image:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="file" name="employeeimage" class="form-control" placeholder="empimage" style="height:70px; border: none;">
