...
//  $productcategory = mysqli_real_escape_string($con,$_POST['productcategory']);
 ...
 $sql = "INSERT INTO productdetails (merchant_id,productname, hsnnumber,availablequantity,purchaseprice,productprice,GST,productdescription,category,productimage,businessname,status) VALUES ('$userid','$productname','$hsnnumber','$availablequantity','$purchaseprice','$productprice','$GST','$productdescription','$category','$folder','$businessname','$status')";
 ...
 if ($sql) {
        ...
        echo '<script type="text/javascript">';
        echo 'alert("Failed to add Product...");';
                                                        ...
                                                        <form method="post" class="font-weight-bold" enctype="multipart/form-data">
                                                            <div class="form-group row mt-3">
                                                              ...
                                                              <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                  <input type="text" name="hsnnumber" value="" class="form-control" placeholder="hsnnumber">
                                                                </div>
                                                              </div>
                                                              <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Availablequantity :</label>
                                                                <div class="col-sm-10">
                                                                  <input type="text" name="availablequantity" class="form-control" placeholder="availablequantity">
                                                              </div>
                                                              </div>
                                                              <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">purchase price :</label>
                                                                <div class="col-sm-10">
                                                                  <input type="text" name="purchaseprice"  class="form-control" placeholder="purchaseprice">
                                                                </div>
                                                            </div>
                                                              <div class="form-group row">
                                                              ...
                                                              <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                  <input type="text" name="productdescription" class="form-control" placeholder="productDesc">
                                                                </div>
                                                              </div>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                 <input type="file" name="productimage" class="form-control" placeholder="productImage" style="height:70px; border: none;">
