                                ...
                                <ul class="show-notification profile-notification">
                                    ...
                                    <li class="waves-effect waves-light">
                                        <a href="subscriptiondetails.php">
                                            <i class="ti-settings"></i> subscriptiondetails
                                        </a>
                                    </li>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Invoices Add</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class=" bg-primary text-white card-header">
                                                        <h5 class="text-white">Add Invoices</h5>
                                                          </div>
                                                    <div class="card-block">
                                                        
                                                        <form class="font-weight-bold" id="add_form">
                                                            <div id="selec_quote" class="form-group row">
                                                                <label for="selectQuote" class="col-sm-2 col-form-label text-primary">Quotation ID:</label>
                                                                  <div class="col-sm-10" >
                                                                  <select class="form-control" id="selectQuote" name="quotationname">
                                                                    <option value='' disabled selected>--Select--</option>
                                                                <?php 
                                                                $query = mysqli_query($con, "SELECT distinct(quotation_id) FROM quotation WHERE user_id = '$userid' and status='Accepted'"); 
                                                                 while($row = mysqli_fetch_array($query)){
                                                                
                                                                   $myquery = mysqli_query($con, "SELECT * FROM quotation WHERE quotation_id=".$row['quotation_id']."");
                                                                   $price = 0;
                                                                   
                                                                   while($myrow = mysqli_fetch_array($myquery)){
                                                                      $price+=$myrow['grandtotal'];
                                                                      $cusname=$myrow['customername'];
                                                                      $qqid=$myrow['quotation_id'];
                                                                   }


                                                                ?>
                                                                    <option value="<?php echo $price; ?>,<?php echo $row['quotation_id'];?>,<?php echo $cusname;?>">quid<?php echo $row['quotation_id'];?></option>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Quotation Amount:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="number" name="quoteamt" id="quoteamt" value="" class="form-control" readonly>
                                                                </div>
                                                            </div>
                                                               <div class="form-group row">
                                                                <label for="advamt" class="col-sm-2 col-form-label text-primary">Advanced Payment:</label>
                                                                  <div class="col-sm-10">
                                                                  <input type="number" name="advamt" id="advamt" value="" class="form-control" max=<?php echo $price;?>>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label for="remamt" class="col-sm-2 col-form-label text-primary">Remaining Payment:</label>
                                                                  <div class="col-sm-10">
                                                                  <input type="number" name="remamt" id="remamt" value="" class="form-control" readonly>
                                                                </div>
                                                            </div>
                                                            <div id="selec_mode" class="form-group row">
                                                                <label for="selectMode" class="col-sm-2 col-form-label text-primary">Mode of Payment :</label>
                                                                  <div class="col-sm-10" >
                                                            ...
                                                            <div class="col-sm-2 mt-2 text-center">
                                                                <input type="hidden" name="quoteid" id="quoteidshow">      
                                                            </div>
                                                             <center><button name="add" id="add_invoice" class="btn btn-primary waves-effect waves-light">Submit</button></center>
                                                        </form>
                                                    </div>
                                                </div>
...
<![endif]-->
  ...
  $("#selectQuote").change(function(){
    ...
    var quoteid = $(this).children("option:selected").val().split(',')[1];
    var cusname = $(this).children("option:selected").val().split(',')[2];

    //console.log(proid);

    $("#quoteamt").attr('value', price);
    $("#quoteidshow").val(quoteid);
    // var prodid = $('#productid').val(proid);
    $("#cusname").attr('value', cusname);

  });

  $("#advamt").change(function(){
    var advpay = $("#advamt").val();
    var quoteamt = $("#quoteamt").val();
   /* if(advpay>quoteamt){
      var advpay = $("#advamt").val(quoteamt);
      $("#remamt").attr('value', 0);
    }
    else{*/
      var remamt = quoteamt - advpay;
      $("#remamt").attr('value', remamt);
    //}
  });
