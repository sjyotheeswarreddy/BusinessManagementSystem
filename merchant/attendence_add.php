...
if (isset($_POST['submit1'])) {
    $userid=1;
 $attend = mysqli_real_escape_string($con,$_POST['select']);
 $start = mysqli_real_escape_string($con,$_POST['starttime']);
 $end = mysqli_real_escape_string($con,$_POST['endtime']);
 $start = explode("T", $start)[0]." ".explode("T", $start)[1].":00";
 $end = explode("T", $end)[0]." ".explode("T", $end)[1].":10";
 
 
 $sql = "INSERT INTO attendance (merchant_id, empid, starttime, endtime, status) VALUES (".$userid.", '".$attend."', '".$start."', '".$end."', '0')";
  $sql1=mysqli_query($con,$sql);

  if ($sql) {
          echo '<script type="text/javascript">';
          echo 'alert("Attendance added Successfully...");';
          echo 'window.location.href="attendence_add.php";';
          echo '</script>';
      } else {
          echo '<script type="text/javascript">';
          echo 'alert("Failed to Add Attendance...");';
          echo 'window.location.href="attendence_add.php";';
          echo '</script>';
      }
 }
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Attendence Add</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class=" bg-primary text-white card-header">
                                                        <h5 class="text-white">Add Attendence</h5>
                                                          </div>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <select name="select" class="form-control" placeholder>
                                                                    ...
                                                                    $query=mysqli_query($con,"SELECT * FROM employeedetails WHERE status = 'a' and merchant_id='$userid'");
                                                                    while($row = mysqli_fetch_array($query)){
                                                                        $emp__id= $row['empid'];
                                                                        ?>
                                                                        <option value="<?php echo $emp__id;?>"> <?php echo $emp__id;?></option>
                                                                        <?php }; ?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mt-3">
                                                            <label class="col-sm-2 col-form-label text-primary">Select Start Time :</label>
                                                                <div class="col-sm-10">
                                                               <input type='datetime-local' id='start' class="form-control" name='starttime' />
                                                            </div>
                                                          </div>
                                                          <div class="form-group row mt-3">
                                                                <label class="col-sm-2 col-form-label text-primary">Select End Time :</label>
                                                                    <div class="col-sm-10">
                                                                   <input type='datetime-local' id='end' class="form-control" name='endtime' />
                                                                </div>
                                                              </div>
