...
$files = $_FILES['img'];
 ...
 $folder = 'support/'.$filename;
 move_uploaded_file($filetmp, $folder);
$status='Pending';

$sql = mysqli_query($con, "INSERT INTO addsupport (user_id,issue_type,message,pro_img,status) VALUES('$user_id','$issue_type','$message','$folder','$status')");
if ($sql) {
            echo '<script type="text/javascript">';
            echo 'alert("Added Successfully...");';
            echo 'window.location.href="tickets_view.php";';
            echo '</script>';
        } else {
            echo '<script type="text/javascript">';
            echo 'alert("Failed to Add...");';
            echo 'window.location.href="tickets_add.php";';
            echo '</script>';
        }
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <form  class="font-weight-bold" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label class= text-primary class= text-uppercase">Upload Problem Image</label>
                                                                <div class="col-sm-10">
