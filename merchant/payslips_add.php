...
if (isset($_POST['submit1'])) {
 ...
 $employeeid = mysqli_real_escape_string($con,$_POST['select']);
 $salary = mysqli_real_escape_string($con,$_POST['salary']);
 $month = mysqli_real_escape_string($con,$_POST['txtDate']);
 
 $sql1 = mysqli_query($con, "SELECT * from payslip where empid='".$employeeid."' and merchant_id=".$userid." and month='".$month."'");
 $myrows = mysqli_num_rows($sql1);
 if($myrows>0){
  echo '<script type="text/javascript">';
  echo 'alert("Cannot add as record already exists");';
  echo 'window.location.href="payslips_add.php";';
  echo '</script>';
 }

 else{
  $sql = "INSERT INTO payslip (merchant_id, empid, salary, month) VALUES (".$userid.", '".$employeeid."', ".$salary.", '".$month."')";
  $sql1=mysqli_query($con,$sql);

  if ($sql) {
          echo '<script type="text/javascript">';
          echo 'alert("Payslips Added Successfully...");';
          echo 'window.location.href="payslips_add.php";';
          echo '</script>';
      } else {
          echo '<script type="text/javascript">';
          echo 'alert("Failed to Add Payslips...");';
          echo 'window.location.href="payslips_add.php";';
          echo '</script>';
      }
 }
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Payslips Add</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="bg-primary text-white card-header">
                                                        <h5 class="text-white">Add Payslips</h5>
                                                          </div>
                                                    <div class="card-block">
                                                        
                                                        <form class="font-weight-bold" method="POST">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Employee id :</label>
                                                                <div class="col-sm-10">
                                                                    <select name="select" class="form-control">
                                                                        <option value="opt1">....Select id....</option>
                                                                        <?php 
                                                                        
                                                                        $query = mysqli_query($con, "SELECT distinct(empid) FROM employeedetails WHERE merchant_id = '$userid'"); 
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Salary :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="number" name="salary" class="form-control" placeholder="salary">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mt-3">
                                                                <label class="col-sm-2 col-form-label text-primary">Select Month :</label>
                                                                <div class="col-sm-10">
                                                                   <input type='month' id='txtDate' class="form-control" name='txtDate'>
                                                                </div>
                                                              </div>
                                                            
                                                             <center><button class="btn btn-primary waves-effect waves-light" name="submit1">Submit</button></center>
                                                        </form>
                                                    </div>
                                                </div>
