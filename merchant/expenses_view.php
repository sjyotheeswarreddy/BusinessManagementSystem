                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Expenses View</h5>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <tbody>
                                                            <?php 
                                                            include('config.php');
                                                            $query = mysqli_query($con,"SELECT * FROM expenses WHERE user_id='$manid'");
                                                            $i = 1;
                                                            while ($row = mysqli_fetch_array($query)) { ?>
                                                            <tr>
                                                            <td><?php echo $i; ?></td>
                                                            <td><?php echo $row['uploaddate']; ?></td>
                                                            <td><?php echo $row['spendfor']; ?></td>
                                                            <td><?php echo $row['spendby']; ?></td>
                                                            <td><a href="expenses_view.php?file=<?php echo $row['billfile']; ?>"><button type="button" class="btn btn-info pt-0 ps-0 pb-1 pe-1">BILL</button></a></td>
