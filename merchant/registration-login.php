...
<head>
  ...
  <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form action="" method="POST" class="md-float-material form-material" enctype="multipart/form-data">
                        ...
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    ...
                                    <span class="form-bar"></span>
                                    <!-- <label class="float-label">GST Number</label> -->
                                </div>
                                <div class="form-group form-primary">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="headname" class="form-control" placeholder="Head Name" required>
                                    <span class="form-bar"></span>
                                    <!-- <label class="float-label">Head Name</label> -->
                                </div>
                                <div class="form-group form-primary">
                                    <input type="text" name="businessproof" class="form-control" placeholder="Business Proof" required>
                                    <span class="form-bar"></span>
                                    <!-- <label class="float-label">Business Proof</label> -->
                                </div>
                                <div class="form-group form-primary">Profile
                                    <input type="file" name="myfile" accept="image/*" class="form-control" required>
                                    <span class="form-bar"></span>
                                   <!-- <h3> <label class="float-label">Profile </label></h3> -->
                                </div>
                              ...
                              <!--  <div class="row m-t-25 text-left">
                                ...
                                <div class="row m-t-30">
                                  <div class="col-md-1"></div>
                                    <div class="col-md-10">
                                      <center> <button type="submit" name="submit" class="btn btn-primary btn-md btn-block waves-effect text-center">Sign up now</button></center>
                                    </div>
                                    <div class="col-md-1"></div>
                                </div>
                                <hr/>
                                <div class="row">
                                    <div class="col-md-10">
                                        <p class="text-inverse text-left m-b-0 ml-3">Thank you.</p>
                                        <p class="text-inverse text-left ml-3"><a href="index-2.html"><b>Back to website</b></a></p>
                                    </div>
                                    <div class="col-md-1">
