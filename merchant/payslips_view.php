                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Payslips View</h5>
                                            ...
                                            <div class="card-block table-border-style">
                                                <div class="table-responsive">
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <?php 
                                                                include('config.php');
                                                                $query = mysqli_query($con, "SELECT * FROM payslip WHERE merchant_id='$userid'");
                                                                $i = 1;
                                                                $myid=0;
                                                                while ($row = mysqli_fetch_array($query)) {
                                                                    $month = $row['month'];
                                                                    $empid = $row['empid'];
                                                                    $myquery = mysqli_query($con, "SELECT * FROM employeedetails WHERE empid='".$row["empid"]."' AND merchant_id='$userid'");
                                                                    $empname='';
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><a href="viewpayslip_pdf.php?id=<?php echo $empid; ?>&mode=view">
                                                                <button type="button" class="btn btn-info pt-0 ps-0 pb-1 pe-1">View</button></a></td>
                                                                <td><a href="viewpayslip_pdf.php?id=<?php echo $empid; ?>&mode=download">
                                                                <button type="button" class="btn btn-info pt-0 ps-0 pb-1 pe-1">Download</button></a></td>
                                                            </tr>
                                                            <?php }; ?>
                                                        </tbody>
                                                    </table>
