...
//     header("location:../subscriptiondetails.php");
// }
?>
<?php 
require_once("config.php");
...
while ($data = mysqli_fetch_array($sql)) {
  ...
  require_once("config.php");
  $query = mysqli_query($con, "SELECT * from payment_subscription where id ='$userid'");
...
<!-- Mirrored from demo.dashboardpack.com/marketing-html/Basic_Elements.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 28 Mar 2022 05:19:47 GMT -->
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="bg-primary text-white card-header">
                                                        <h4 class="text-white">Plane details</h4>
                                                          </div>
