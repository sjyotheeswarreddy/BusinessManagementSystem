...
if (isset($_POST['submit'])) {
 ...
 $spendfor = mysqli_real_escape_string($con,$_POST['spendFor']);
 $spendby = mysqli_real_escape_string($con,$_POST['spendBy']);
 $amountspend = mysqli_real_escape_string($con,$_POST['amountspend']);
 $files = $_FILES['billdetails'];
 $filename = $files['name'];
 $filetmp = $files['tmp_name'];    
 $folder = './expenses/'.$filename;
 move_uploaded_file($filetmp, $folder);



 $sql = "INSERT INTO expenses (user_id,uploaddate,spendfor,spendby,billfile,amount) VALUES ('$user_id','$date','$spendfor','$spendby','$folder','$amountspend')";
 $sql1=mysqli_query($con,$sql);

 if ($sql) {
        echo '<script type="text/javascript">';
        echo 'alert("Expenses added Successfully...");';
        echo 'window.location.href="expenses_view.php";';
        echo '</script>';
    } else {
        echo '<script type="text/javascript">';
        echo 'alert("Failed to add Expenses...");';
        echo 'window.location.href="expenses_add.php";';
        echo '</script>';
    }
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Expenses Add</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="bg-primary text-white card-header">
                                                        <h5 class="text-white">Add Expences</h5>
                                                          </div>
                                                    <div class="card-block">
                                                        ...
                                                        <form class="font-weight-bold" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Spend For  :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="spendFor" class="form-control" placeholder="spendfor">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Spend By  :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="spendBy" class="form-control" placeholder="spendby">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Bill Details  :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="file" name="billdetails" class="form-control" placeholder="bill details">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Amount  :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="number" name="amountspend" class="form-control" placeholder="amount">
                                                                </div>
                                                            </div>
