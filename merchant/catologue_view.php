                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Catologue View</h5>
...
$sql = mysqli_query($con, "SELECT * FROM productdetails WHERE businessname='$businessname'");
while ($data = mysqli_fetch_array($sql)) {
    $id=$data['id'];
...
<td ><img src="<?php echo $productimage; ?>" style="width: 50px;height: 50px; border-radius: 50%;"></td>
<td >                 <a href="catologue_update.php?id=<?php echo $id; ?>" ><i class="fas fa-edit fa-1x" id="update"></i></a>
     <a href="delete_catu.php?id=<?php echo $id; ?>" ><i class="fas fa-trash fa-1x" id="delete"></i></a>
                                     <!-- <td style="text-align: center;background-color:white;margin-top: 15px;"> -->
                 <?php 
                    if($data['status']=="a") 
  
                         echo 
"<a href=catologue_deact.php?id=".$data['id']."><i class='fas fa-solid green fa-1x fa-eye' style='color:green;'></i></a>";
                    else 
                        echo 
"<a href=catologue_act.php?id=".$data['id']."><i class='fas fa-solid red fa-1x fa-eye-slash' style='color:red;'></i></a>";
                    ?>
</tr>
                                                            <?php 
$i++;
