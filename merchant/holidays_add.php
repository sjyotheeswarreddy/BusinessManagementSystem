...
if (isset($_POST['submit'])) {
 $holiday = mysqli_real_escape_string($con,$_POST['reason']);
 $month = mysqli_real_escape_string($con,$_POST['txtDate']);

 
 $sql = "INSERT INTO holidays (merchant_id, name, date) VALUES ('$userid', '$holiday', '$month')";
  $sql1=mysqli_query($con,$sql);

  if ($sql) {
          echo '<script type="text/javascript">';
          echo 'alert(" Holiday Added Successfully...");';
          echo 'window.location.href="holidays_add.php";';
          echo '</script>';
      } else {
          echo '<script type="text/javascript">';
          echo 'alert("Failed to Add Holiday...");';
          echo 'window.location.href="holidays_add.php";';
          echo '</script>';
      }
 }
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Holidays Add</h5>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="bg-primary text-white card-header">
                                                        <h5 class="text-white">Add Holidays</h5>
                                                          </div>
                                                    <div class="card-block">
                                                        
                                                        <form class="font-weight-bold" method="POST">
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label text-primary">Reason :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control" name="reason" placeholder="Reason" required>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row mt-3">
                                                                <label class="col-sm-2 col-form-label text-primary">Select Date :</label>
                                                                <div class="col-sm-10">
                                                                   <input type='date' id='txtDate' class="form-control" name='txtDate' />
                                                                </div>
                                                              </div>
                                                            
                                                             <center><button name="submit" class="btn btn-primary waves-effect waves-light">Submit</button></center>
                                                        </form>
                                                    </div>
                                                </div>
