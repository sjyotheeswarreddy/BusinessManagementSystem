...
error_reporting(0);
$query = mysqli_query($con, "SELECT * from merchant where id ='$userid'");
                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        ...
                                                        <form class="font-weight-bold" method="POST" enctype="multipart/form-data">
                                                            <div class="form-group row"id="two">
                                                                <label class="col-sm-3 col-form-label  text-primary font-weight-bold"id="profile">Name:</label><?php echo $Head_Name; ?>
                                                            </div>
                                                           <div class="form-group row"id="two">
                                                                <label class="col-sm-3 col-form-label text-primary font-weight-bold"id="profile1">businessname :</label><?php echo $UserName; ?>
                                                                <div class="col-sm-10">
                                                            </div>
                                                          </div>
                                                            <div class="form-group row"id="two">
                                                                <label class="col-sm-3 col-form-label text-primary font-weight-bold"id="profile2">PhoneNumber :</label><?php echo $PhoneNumber; ?>
                                                                <div class="col-sm-10">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row"id="two">
                                                                <label class="col-sm-3 col-form-label text-primary font-weight-bold"id="profile3">email :</label><?php echo $email; ?>
                                                                <div class="col-sm-10">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row"id="two">
                                                            ...
                                                            <div class="form-group row"id="two">
                                                                <label class="col-sm-3 col-form-label text-primary font-weight-bold"id="profile5">businessproof :</label><?php echo $businessproof; ?>
                                                                <div class="col-sm-10">
                                                                </div>
                                                            </div>
                                                            <!-- <button class="msg-btn"><input type="submit"name="submit" value="Update" ></button> -->

                                                           <center><button type="submit" name="submit" class="btn btn-primary waves-effect waves-light "><a href="update.php?updateid=<?php echo $userid; ?>">Edit</a></button></center>                                                           <!-- <div class="form-group row">
