                                                    ...
                                                    <table class="table table-hover table-bordered">
                                                        <thead>
                                                            <tr class="bg-primary text-white">
                                                               <th scope="col" class="text-white bg-primary p-2 rounded-left">S.No</th>
                                                                <th scope="col" class="text-white bg-primary p-2">Payment ID</th>
                                                                <th scope="col" class="text-white bg-primary p-2">Customer Name</th>
                                                                <th scope="col" class="text-white bg-primary p-2">Date</th>
                                                                <th scope="col" class="text-white bg-primary p-2">Payment Mode</th>
                                                                <th scope="col" class="text-white bg-primary p-2 rounded-right">Amount</th>
                                                        </thead>
                                                        <tbody>
                                                          <?php 
                                                        include('config.php');
                                                        $query = mysqli_query($con,"SELECT * FROM paymenthistory WHERE user_id='$manid'");
                                                        $i = 1;
